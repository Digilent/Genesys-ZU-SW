...
set lang "c"
set domain "5ev_domain_fsbl"
set platform "5ev_hw_pf"
set sysproj "5ev_boot"
...
# app config -set -name $app_name compiler-misc {-c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects}
# app config -set -name $app_name compiler-optimization {Optimize more (-O2)}
# app config -add -name $app_name define-compiler-symbols {ARMA53_64}
# app config -add -name $app_name include-path $script_dir/src
# app config -set -name $app_name linker-misc { -n}
