...
# BUG 2020.1: importsources called on paths that are already imported linked will
# delete sub-dirs in those paths from src/ (extremely grave)
...
set lang "c"
set domain "5ev_standalone_bsp"
set platform "5ev_hw_pf"
set sysproj "5ev_hdmi_demo_system"
